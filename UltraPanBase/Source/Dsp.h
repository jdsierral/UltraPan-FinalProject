...
class Dsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("delay", &fslider0, 0.0f, 0.0f, 65536.0f, 0.01f);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp1 = ((int((fRec0[1] != 0.0f)))?((int(((fRec1[1] > 0.0f) & (fRec1[1] < 1.0f))))?fRec0[1]:0):((int(((fRec1[1] == 0.0f) & (fRec4[0] != fRec2[1]))))?0.001953125f:((int(((fRec1[1] == 1.0f) & (fRec4[0] != fRec3[1]))))?-0.001953125f:0)));
			fRec0[0] = fTemp1;
			fRec1[0] = max(0.0f, min(1.0f, (fRec1[1] + fTemp1)));
			fRec2[0] = ((int(((fRec1[1] >= 1.0f) & (fRec3[1] != fRec4[0]))))?fRec4[0]:fRec2[1]);
			fRec3[0] = ((int(((fRec1[1] <= 0.0f) & (fRec2[1] != fRec4[0]))))?fRec4[0]:fRec3[1]);
			fRec5[0] = (fSlow1 + (0.999f * fRec5[1]));
			output0[i] = (FAUSTFLOAT)(((fVec0[(IOTA-int((int(fRec2[0]) & 65535)))&65535] * (1.0f - fRec1[0])) + (fRec1[0] * fVec0[(IOTA-int((int(fRec3[0]) & 65535)))&65535])) * fRec5[0]);
			// post processing
			fRec5[1] = fRec5[0];
			fRec3[1] = fRec3[0];
			fRec2[1] = fRec2[0];
